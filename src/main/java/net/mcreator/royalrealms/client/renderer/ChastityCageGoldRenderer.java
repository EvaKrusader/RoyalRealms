...
public class ChastityCageGoldRenderer implements ICurioRenderer {
	...
	public ChastityCageGoldRenderer() {
		this.model = new Modelchastity_cage(Minecraft.getInstance().getEntityModels().bakeLayer(RoyalrealmsModLayerDefinitions.CHASTITY_CAGE_GOLD));
	}
