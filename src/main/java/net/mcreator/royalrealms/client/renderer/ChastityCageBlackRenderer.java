...
public class ChastityCageBlackRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("royalrealms", "textures/entities/chastity_cage_test.png");
	private final Modelchastity_cage model;

	public ChastityCageBlackRenderer() {
		this.model = new Modelchastity_cage(Minecraft.getInstance().getEntityModels().bakeLayer(RoyalrealmsModLayerDefinitions.CHASTITY_CAGE_BLACK));
	}
