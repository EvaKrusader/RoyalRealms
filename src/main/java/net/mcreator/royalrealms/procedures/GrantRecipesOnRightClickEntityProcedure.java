...
public class GrantRecipesOnRightClickEntityProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity sourceentity) {
		...
		if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.NAME_TAG) {
			if (sourceentity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.awardRecipesByKey(new ResourceLocation[]{new ResourceLocation("royalrealms:nametag_recipe")});
		}
	}
}
