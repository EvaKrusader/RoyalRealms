package net.mcreator.royalrealms;
...
@Mod("royalrealms")
public class RoyalrealmsMod {
	public static final Logger LOGGER = LogManager.getLogger(RoyalrealmsMod.class);
	public static final String MODID = "royalrealms";

	public RoyalrealmsMod() {
