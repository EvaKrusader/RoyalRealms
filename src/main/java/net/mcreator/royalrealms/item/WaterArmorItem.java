...
public abstract class WaterArmorItem extends ArmorItem {
	public WaterArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(RoyalrealmsModItems.FALL_BREAKER_CHARM.get()));
			}
	...
	public static class Helmet extends WaterArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "royalrealms:textures/models/armor/water_layer_1.png";
		}
	}
	...
	public static class Leggings extends WaterArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "royalrealms:textures/models/armor/water_layer_2.png";
		}
	}
