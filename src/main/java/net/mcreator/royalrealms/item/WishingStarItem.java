...
import net.mcreator.royalrealms.procedures.WishingStarPlayerFinishesUsingItemProcedure;

public class WishingStarItem extends Item {
	public WishingStarItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		WishingStarPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
		return retval;
	}
}
