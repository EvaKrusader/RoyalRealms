...
import net.mcreator.royalrealms.procedures.EnderlinkPlayerFinishesUsingItemProcedure;
...
public class EnderlinkItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		EnderlinkPlayerFinishesUsingItemProcedure.execute(world, x, y, z, entity);
		return retval;
	}
}
